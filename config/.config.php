...
// 用户签到设置
$System_Config['checkinMin'] = '10';       // 签到最少流量 单位MB
...
#测速周期/h
$System_Config['Speedtest_duration']='24';
...
#系统根域名 zhaoj.in 这样
$System_Config['wecenter_system_main_domain']='.com';
...
#启用登录验证码
$System_Config['enable_geetest_login']='true';
